(() => {
  ...
  const R = {
      attachEvents: function () {
        ...
        (e.onTouchStart = D.bind(e)),
          ...
          (e.onClick = F.bind(e)),
          i.touch && !q && (t.addEventListener("touchstart", V), (q = !0)),
          W(e, "on");
      },
  ...
  function ie(e) {
    ...
    function p() {
      ...
      if (
        (t.params.loop
          ? ((a = Math.ceil(
            ...
            a > i - 1 - 2 * t.loopedSlides && (a -= i - 2 * t.loopedSlides),
            a > p - 1 && (a -= p),
            a < 0 && "bullets" !== t.params.paginationType && (a = p + a))
          : (a = void 0 !== t.snapIndex ? t.snapIndex : t.activeIndex || 0),
        "bullets" === s.type &&
        ...
        if (
          (s.dynamicBullets &&
            ...
            s.dynamicMainBullets > 1 &&
              ...
              ((o += a - (t.previousIndex - t.loopedSlides || 0)),
              o > s.dynamicMainBullets - 1
                ? (o = s.dynamicMainBullets - 1)
                : o < 0 && (o = 0)),
            (n = Math.max(a - o, 0)),
            (d = n + (Math.min(i.length, s.dynamicMainBullets) - 1)),
            (p = (d + n) / 2)),
          i.removeClass(
          ...
          i.each((e) => {
            ...
            i === a && t.addClass(s.bulletActiveClass),
              s.dynamicBullets &&
                (i >= n && i <= d && t.addClass(`${s.bulletActiveClass}-main`),
                i === n && c(t, "prev"),
                i === d && c(t, "next"));
          });
        else {
      ...
      if (
        ("fraction" === s.type &&
          (r.find(se(s.currentClass)).text(s.formatFractionCurrent(a + 1)),
          r.find(se(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
      ...
      "custom" === s.type && s.renderCustom
        ? (r.html(s.renderCustom(t, a + 1, p)), n("paginationRender", r[0]))
    ...
    function u() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(r), (t.pagination.bullets = i.find(se(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((r = e.renderFraction
    ...
    function h() {
      ...
      0 !== s.length &&
        ...
        e.clickable &&
          s.on("click", se(e.bulletClass), function (e) {
            e.preventDefault();
    ...
    function f() {
      ...
      s.removeClass(e.hiddenClass),
        ...
        e.clickable && s.off("click", se(e.bulletClass));
    }
    i("init", () => {
      h(), u(), p();
    }),
  ...
  function ne(e, t, s) {
    ...
    return (
      r.length ||
        ((r = g(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`)),
        n.append(r)),
      r
    );
  }
      ...
      setTranslate: () => {
        ...
        for (let e = 0, t = i.length; e < t; e += 1) {
          const t = i.eq(e),
            ...
            p =
              "function" == typeof r.modifier ? r.modifier(l) : l * r.modifier;
          let u = a ? d * p : 0,
            h = a ? 0 : d * p,
            f = -c * Math.abs(p),
            m = r.stretch;
          ...
          if (
            ...
            0 === e.length && (e = ne(r, t, a ? "left" : "top")),
              0 === s.length && (s = ne(r, t, a ? "right" : "bottom")),
  ...
  window.addEventListener("load", function (e) {
    document.querySelector(".presentation__slider") &&
      new te(".presentation__slider", {
        modules: [ie, ae],
        grabCursor: !0,
        effect: "coverflow",
    ...
    document.querySelector(".icon-menu").addEventListener("click", () => {
      document
        ...
        document
          ...
          .classList.toggle("icon-menu--active"),
        document.querySelector("body").classList.toggle("body-hidden");
    });
  const le = document.querySelector(".scroll-btn"),
    oe = document.querySelector(".scroll-btn");
  window.addEventListener("scroll", () => {
    window.pageYOffset >= 300
      ? le.classList.add("scroll-btn-active")
      : le.classList.remove("scroll-btn-active");
  }),
    ...
    (function () {
      ...
      if (i.length > 0) {
        const n = Array.from(i).filter(function (e, t, s) {
        ...
        function d(t) {
          ...
          s &&
            ...
            (s.classList.remove("_spoller-active"), e(s.nextElementSibling, i));
        }
        r &&
          r.length &&
          r.forEach((e) => {
